...
/* 
*This function takes a UTF string input and returns a 4 character hex cipher(fingerprint) of the input using UTF Zero-Width Characters(ZWC).
16 different ZWC's are mapped to represent the four 0-F hex values.
...
A four character input will generate a 16 character 'invisible' cipher.
...
var stringCipher = cipher("zZ@@4#4$%6^&788(*(&*&^^%z123");

console.log(stringCipher);

var stringDeCipher = deCipher(stringCipher);
